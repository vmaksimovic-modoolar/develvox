...
class syscoonFinanceinterfaceBookingformLines(models.Model):
    ...
    def create_invoice(self, line):
        ...
        invoice_vals = {
            ...
            'fiscal_position_id': line[0].partner_id.property_account_position_id.id,
    ...
    def create_split_invoice(self, lines):
        ...
        invoice_vals = {
            ...
            'type': inv_type,
            'account_id': account_id.id,
            'partner_id': inv_vals.partner_id.id,
            'journal_id': journal_id,
            'currency_id': inv_vals.currency_id.id,
            'payment_term_id': payment_term.id,
            'fiscal_position_id': inv_vals.partner_id.property_account_position_id.id,
    ...
    def create_invoice_lines(self, invoice, lines):
        ...
        invoice_line_ids = []
        for line in lines:
            if line.move_type == 'customer_invoice' or line.move_type == 'customer_refund':
                account_id = line.counteraccount_id
            if line.move_type == 'supplier_invoice' or line.move_type == 'supplier_refund':
